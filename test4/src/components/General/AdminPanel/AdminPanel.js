...
<div className='practice-audio hidden' ref={training}>
    Practice audio
                    ...
                    <form action = ''>
                        ...
                        <option value = 'monologue12'>IBM Listening (mono)</option>
                        <option value = 'monologue13'>IBM Telum Processor (mono)</option>
                        ...
                        <option value = 'dialogue6'>Charlotte & Seth (dia)</option>
