...
//   },[numberOfSubs])
  ...
  return (
    <div className={myState.amAdmin ? "call-with-sidebar" : "call"}>
      ...
      <div className={`large-tiles ${containsScreenShare(callState.callItems)&&'screenshare'} count-${(containsScreenShare(callState.callItems)&&'1')||window.numberOfSubs && window.numberOfSubs+1}`}>   
        {
          !message
            ? largeTiles
