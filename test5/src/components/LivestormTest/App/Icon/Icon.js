...
export default function Icon(props) {
  ...
  function getPath() {
    switch (props.type) {
	 ...
	 viewBox="0 0 120 130">
<g>
<path d="M56.7,0C25.4,0,0,25.4,0,56.7s25.4,56.7,56.7,56.7c31.3,0,56.7-25.4,56.7-56.7S88.1,0,56.7,0z M56.7,111.1
		c-30,0-54.3-24.4-54.3-54.3S26.8,2.4,56.7,2.4c30,0,54.3,24.4,54.3,54.3S86.7,111.1,56.7,111.1z"
    fill={getFillColor()}
    />
	<ellipse transform="matrix(0.3569 -0.9341 0.9341 0.3569 -16.5128 89.4864)" cx="56.7" cy="56.7" rx="49.6" ry="49.6"
    fill={getFillColor()}
/>
</g>
</svg>
